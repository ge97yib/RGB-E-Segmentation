...
class RGBXTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512], 
        ...
        #here is only ffm part used for CAFR
        self.FFMs = nn.ModuleList([
                    FFM(embed_dims[0],embed_dims[0]),
                    FFM(embed_dims[1],embed_dims[1]),
                    FFM(embed_dims[2],embed_dims[2]),
                    FFM(embed_dims[3],embed_dims[3])])
    ...
    def forward_features(self, x_rgb, x_e):
        ...
        # print("stage1 x_rgb:", x_rgb.shape)
        # print("stage1 x_e:", x_e.shape)
        #x_rgb, x_e = self.FRMs[0](x_rgb, x_e)
        # print("stage1 x_rgb after FRM:", x_rgb.shape)
        # print("stage1 x_e after FRM:", x_e.shape)
        x_fused, stage_loss1 = self.FFMs[0](x_rgb, x_e)
        # print("stage1 x_rgb after FFM:", x_rgb.shape)
        # print("stage1 x_e after FFM:", x_e.shape)
        # print("stage1 x_fused after FFM:", x_fused.shape)
        outs.append(x_fused)
        ...
        x_rgb = x_rgb.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        x_e = x_e.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        # print("stage2 x_rgb:", x_rgb.shape)
        # print("stage2 x_e:", x_e.shape)
        #x_rgb, x_e = self.FRMs[1](x_rgb, x_e)
        # print("stage2 x_rgb after FRM:", x_rgb.shape)
        # print("stage2 x_e after FRM:", x_e.shape)
        x_fused, stage_loss2 = self.FFMs[1](x_rgb, x_e)
        # print("stage2 x_rgb after FFM:", x_rgb.shape)
        # print("stage2 x_e after FFM:", x_e.shape)
        # print("stage2 x_fused after FFM:", x_fused.shape)
        outs.append(x_fused)
        ...
        x_rgb = x_rgb.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        x_e = x_e.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        # print("stage3 x_rgb:", x_rgb.shape)
        # print("stage3 x_e:", x_e.shape)
        #x_rgb, x_e = self.FRMs[2](x_rgb, x_e)
        # print("stage3 x_rgb after FRM:", x_rgb.shape)
        # print("stage3 x_e after FRM:", x_e.shape)
        x_fused, stage_loss3 = self.FFMs[2](x_rgb, x_e)
        # print("stage3 x_rgb after FFM:", x_rgb.shape)
        # print("stage3 x_e after FFM:", x_e.shape)
        # print("stage3 x_fused after FFM:", x_fused.shape)
        outs.append(x_fused)
        ...
        x_rgb = x_rgb.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        x_e = x_e.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        # print("stage4 x_rgb:", x_rgb.shape)
        # print("stage4 x_e:", x_e.shape)
        #x_rgb, x_e = self.FRMs[3](x_rgb, x_e)
        # print("stage4 x_rgb after FRM:", x_rgb.shape)
        # print("stage4 x_e after FRM:", x_e.shape)
        x_fused, stage_loss4 = self.FFMs[3](x_rgb, x_e)
        # print("stage4 x_rgb after FFM:", x_rgb.shape)
        # print("stage4 x_e after FFM:", x_e.shape)
        # print("stage4 x_fused after FFM:", x_fused.shape)
        outs.append(x_fused)
        lat_loss = stage_loss1 + stage_loss2 + stage_loss3 + stage_loss4
        
        return outs, lat_loss

    def forward(self, x_rgb, x_e):
        out, total_stage_loss = self.forward_features(x_rgb, x_e)
        return out, total_stage_loss
